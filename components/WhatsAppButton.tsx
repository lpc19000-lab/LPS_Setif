...
export default function WhatsAppButton({ phoneNumber }: WhatsAppButtonProps) {
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 z-[60] flex items-center justify-center w-14 h-14 bg-green-500 text-white rounded-full shadow-2xl hover:bg-green-600 hover:scale-110 transition-all duration-300 group"
