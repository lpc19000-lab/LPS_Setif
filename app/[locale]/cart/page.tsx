        ...
        <main className="pt-24 pb-20 min-h-screen bg-[#FAFAF8]">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    ...
                    <Link
                        href={`/${locale}/catalog`}
                        className="text-sm font-bold text-primary hover:text-primary-dark transition-colors flex items-center gap-2 group w-fit"
                    >
                        <ChevronRight className={`w-4 h-4 ${isRtl ? "rotate-0 group-hover:translate-x-1" : "rotate-180 group-hover:-translate-x-1"} transition-transform`} />
                        {t("back_to_catalog")}
                    </Link>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0 w-full">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-3">
                                                        ...
                                                        <p className="text-[#D4AF37] text-[10px] font-black uppercase tracking-[0.2em]">
                                                            {item.product.weight >= 1000 ? `${item.product.weight / 1000}kg` : `${item.product.weight}g`} {t("edition")}
                                                        </p>
                                                    </div>
                                                </div>
                                                <button
                                                    onClick={() => removeItem(item.id)}
                                                    className="w-10 h-10 rounded-xl flex items-center justify-center text-gray-200 hover:text-red-500 hover:bg-red-50 transition-all border border-transparent hover:border-red-100"
                                            ...
                                            <div className="flex flex-wrap items-end justify-between gap-6">
                                                <div className="flex items-center bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 p-1">
                                                    <button
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-[#111111] text-white rounded-[2.5rem] p-8 md:p-10 shadow-2xl shadow-gray-200 sticky top-28 overflow-hidden group border border-white/5">
                                <h2 className="text-2xl font-serif font-bold mb-10 italic flex items-center gap-3">
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        <span className="relative z-10 flex items-center gap-2">
                                            {t("checkout_now")}
                                            <ArrowRight className={`w-5 h-5 group-hover:${isRtl ? "-translate-x-2" : "translate-x-2"} transition-transform duration-300`} />
                                        </span>
                                ...
                                {/* Decoration */}
                                <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-[#D4AF37]/5 rounded-full blur-[80px] pointer-events-none group-hover:bg-[#D4AF37]/10 transition-colors duration-1000"></div>
                            </div>
                        </div>
                    </div>
                )}
