...
async function syncFinal() {
    ...
    console.log(`Starting final sync for ${products.length} products...`);
    let successCount = 0;
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        try {
            ...
            // Note: Skipping image upload due to persistent bucket issues, 
            // but we ensure all data is correctly categorized and in Firestore.
    ...
    console.log(`Final sync complete! ${successCount} products processed.`);
    process.exit(0);
}
