                                        ...
                                        <div className="flex-1 min-w-0 pr-2">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <p className="text-sm font-bold text-gray-950">
                                                    {(Number(item.product.basePrice) * item.quantity).toLocaleString()} <span className="text-[10px] text-gray-400 font-normal">DA</span>
                                                </p>
                                            </div>
                                        </div>
                                    </motion.div>
                            ...
                            <div className="p-6 border-t border-gray-100 bg-white/80 backdrop-blur-md">
                                <div className="space-y-3 mb-6">
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <p className="font-bold text-gray-900">{totalPrice.toLocaleString()} DA</p>
                                    </div>
                                    <div className="flex justify-between items-center text-sm">
                                    ...
                                    <div className="pt-3 border-t border-gray-100 flex justify-between items-end">
                                        ...
                                        <p className="text-2xl font-serif font-bold text-primary-dark">
                                            {totalPrice.toLocaleString()} <span className="text-xs text-gray-400 font-sans">DA</span>
                                        </p>
                                    </div>
                                </div>
