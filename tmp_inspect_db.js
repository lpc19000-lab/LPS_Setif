...
// Use env vars similar to .env.local (assuming they are set in the environment or extracted)
// For local execution, I'll use the provided literal values from the prompt safely.
...
async function inspect() {
  ...
  for (const coll of collections) {
    try {
      ...
      console.error(`Error inspecting ${coll}:`, e.message);
    }
  }
}
