        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 pt-32 pb-20">
            <div className="max-w-xl w-full">
                ...
                <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/50">
                    ...
                    {/* Google Register Button (Disabled during migration) */}
                    <div className="space-y-4">
                        <button
                            type="button"
                            onClick={() => alert("Google registration is temporarily disabled during our migration to Supabase. Please use the form above or check back soon!")}
                        ...
                        >
                            ...
                            Continuer avec Google (Migration en cours)
                        </button>
                        <p className="text-[10px] text-center text-gray-400 italic">
                            * Nous migrons actuellement de Firebase vers Supabase pour une meilleure expérience.
                        </p>
                    </div>
                </div>
