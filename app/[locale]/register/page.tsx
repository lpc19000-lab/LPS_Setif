                    ...
                    <button
                        onClick={async () => {
                            ...
                            try {
                                ...
                                // Call login API to set cookies
                                const response = await fetch("/api/customers/login", {
                                    method: "POST",
                                    headers: { "Content-Type": "application/json" },
                                    body: JSON.stringify({ googleToken: await user.getIdToken() }),
                                });
                        ...
                        disabled={loading}
                        className="w-full bg-white border border-gray-100 text-gray-600 py-4 rounded-2xl font-bold hover:bg-gray-50 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                    >
